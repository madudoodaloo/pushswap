...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/08/06 19:58:35 by masilva-@st       #+#    #+#             */
/*   Updated: 2026/08/06 20:15:04 by masilva-@st      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../push_swap.h"

static int	highest_without_chunk(t_stack **head)
{
	int		highest;
	t_stack	*node;
...
static void	mark_chunk(t_stack **head, int chunk, int n)
{
	int		highest;
	t_stack	*node;
...
static void	push_chunks(t_stack **head_a, t_stack **head_b, int chunk)
{
	t_stack	*node;
	int		i;
...
static void	sort_chunk(t_stack **head_a, t_stack **head_b)
{
	int	highest;
